...
def login():
        ...
        if request.method == 'POST':
            usernameFormLogin = request.form['username']
            passwordFormLogin = request.form['password']
            ...
            for user in userDb:
                if usernameFormLogin == user.username and passwordFormLogin == user.password:
                    return redirect('/index')

                else: 
                    error = 'yanlış şifre veya kullanıcı adı'
...
def reg():
    if request.method == 'POST':
        ...
        newUser = User(username = usernameForm , password = passwordForm)
